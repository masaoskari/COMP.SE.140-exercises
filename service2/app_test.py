import pytest
from app import app, collect_service_info
...
def test_service_info(client, mocker):
    ...
    expected_info = {
        ...
        "diskSpace": {"Filesystem": "/", "Size": "100G", "Used": "50G", "Avail": "50G", "Use%": "50%", "Mounted on": "/"},
        "processes": [{"PID": "1", "TTY": "?", "STAT": "Ss", "TIME": "0:00", "COMMAND": "init"}],
        "serviceUptime": 1000,
        "osUptime": 10000,
    }
